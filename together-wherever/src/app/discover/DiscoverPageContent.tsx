...
const DiscoverPageContent = ({accessFromPlanningPage}: { accessFromPlanningPage?: boolean }) => {
    ...
    useEffect(() => {
        if (accessFromPlanningPage && params?.placeId) {
            fetchPlaceDetails("ChIJ_YjQ6uQxUDARHVetUBkoi9k"); // Fetch data automatically for dynamic pages
        }
    }, [accessFromPlanningPage, params?.placeId]);
