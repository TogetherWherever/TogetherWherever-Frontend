...
import { ArrowLeftIcon, EllipsisHorizontalIcon, ArrowRightIcon } from "@heroicons/react/24/solid";
...
const dialogTxt = {
  topic: "Complete Vote",
  desc: "Please confirm that you want to complete your vote."
};
...
export default function VotingPage() {
  ...
  const { tripDetails, destinations, scores, handleScoreChange, loading } = useDestinationVoting();
    ...
    <div className="flex flex-col w-full h-full">
      ...
      <div className="flex h-14 justify-between w-full items-center px-5 py-10">
        <div className="flex w-full h-full items-center gap-2">
          <ArrowLeftIcon className="h-8 cursor-pointer" onClick={() => router.push(`/planning/${tripId}`)} />
